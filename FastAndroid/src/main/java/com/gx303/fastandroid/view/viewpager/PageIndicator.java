...
public class PageIndicator extends LinearLayout implements ViewPager.OnPageChangeListener {
    ...
    public void setViewPager(FastLoopViewPager pager) {
        mViewPager = pager;
//        pager.addOnPageChangeListener(this);
    ...
    public void setIndicatorType(IndicatorType indicatorType) {
        ...
        if (mViewPager != null) {
            addIndicator(mViewPager.getCount());
        }
    }
    ...
    private void addIndicator(int count) {
        ...
        updateIndicator(mViewPager.getCurrentItem1());
    }
     ...
     * We could keep a list of listeners by {@link android.support.v4.view.ViewPager#setOnPageChangeListener(ViewPager.OnPageChangeListener)}.
     */
    @Deprecated
    ...
    public void onPageSelected(int position) {
        updateIndicator(position%mViewPager.getCount());
    }
